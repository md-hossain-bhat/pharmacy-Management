...
Route::prefix('/admin')->namespace('Admin')->group(function(){
 ...
 Route::group(['middleware' => ['admin']], function () {
  ...
  //user 
    ...
    Route::match(['get','post'],'/add-edit-company/{id?}','CompanyController@AddEditCompany');
    ...
    Route::get('/expire-medicine','PurchaseController@expireMedicine');
    Route::get('/expire-medicine-pdf','PurchaseController@expireMedicinePDF');
    Route::get('/upcomming-stockout','PurchaseController@upcommingStockOut');
    Route::get('/upcomming-stockout-pdf','PurchaseController@upcommingStockOutPdf');
    ...
    Route::get('invoice-details/{id}','InvoiceController@InvoiceDetails');
    //defult controller
    Route::get('/get-company','DefaultController@getComany')->name('get-company');
    Route::get('/get-category','DefaultController@getCategory')->name('get-category');
    Route::get('/get-brand','DefaultController@getBrand')->name('get-brand');
