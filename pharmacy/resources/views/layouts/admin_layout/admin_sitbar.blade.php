<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('admin/dashboard')}}" class="brand-link">
      <!-- <img src="{{asset('images/admin_img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8"> -->
      <span class="brand-text font-weight-light">Hena Ahmed Hospital</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if(Session::get('page') == 'purchases' || Session::get('page') == 'pandding' || Session::get('page') == 'dalypurchasereport' || Session::get('page') == 'stockreport' || Session::get('page') == 'stockSupplierProductwise')
          <?php $active = "active"; ?>
          <?php $open = "menu-open"; ?>
        @else
          <?php $active = ""; ?>
        ...
        @endif
          ...
          @if(Session::get('page') == 'invoice' || Session::get('page') == 'pandding_invoice' || Session::get('page') == 'daly_report')
          <?php $active = "active"; ?>
          <?php $open = "menu-open"; ?>
        @else
          <?php $active = ""; ?>
        ...
        @endif
          ...
          @if(Session::get('admiDetails')['type'] == "Super Admin" || Session::get('admiDetails')['type'] == "Manager")
          @if(Session::get('page') == 'units' || Session::get('page') == 'categories' || Session::get('page') == 'brands' || Session::get('page') == 'products' || Session::get('page') == 'companies')
            <?php $active = "active"; ?>
            <?php $open = "menu-open"; ?>
          @else
            <?php $active = ""; ?>
