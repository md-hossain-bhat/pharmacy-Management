              ...
              <div class="card-body">
                <table id="customers" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    @php
                      $count = App\Payment::where('customer_id',$customer->id)->count();
                    @endphp
                    <td>
                      <a href="{{url('admin/add-edit-customer/'.$customer['id'])}}" title="customer edit"><i class="fas fa-edit"></i></a> 
                      @if($count < 1) /  <a
                     class="confirmDelete" record="customer" recoedid="{{$customer['id']}}" href="javascript:void('0')"><i style="color:red;" class="fa fa-trash"></i></a>
                     @endif
                     </td>
                  </tr>
                   @endforeach
