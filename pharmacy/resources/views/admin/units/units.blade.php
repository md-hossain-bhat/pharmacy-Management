          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{url('admin/add-edit-unit')}}" style="float: right;"><button type="button" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add Strength</button></a>
              </div>
