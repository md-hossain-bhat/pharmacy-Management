      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            ...
            <a href="{{url('admin/units')}}" style="float:right;"><button class="btn btn-success btn-sm"><i class="fas fa-list"></i> Strength List</button></a>
	            ...
	            <div class="row">
	              <div class="col-md-6">
	              	<div class="form-group">
	                    <label for="name">Strength Name</label>
