              ...
              <div class="card-body">
                <table id="invoices" class="table table-bordered table-striped table-responsive">
                  ...
                  <tr>
                    ...
                    <td><a title="print invoice" class="btn btn-success btn-sm" target="_blanck" href="{{url('admin/print-invoice/'.$invoice['id'])}}"><i class="fa fa-print"></i></a> 
                    &nbsp;
                    <a title="print invoice" class="btn btn-info btn-sm" target="_blanck" href="{{url('admin/invoice-details/'.$invoice['id'])}}"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
