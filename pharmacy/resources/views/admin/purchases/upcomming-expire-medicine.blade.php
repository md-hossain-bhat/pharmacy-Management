...
@section('title','Upcomming Stockout List')
  @section("content")
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a target="_blanck" href="{{url('admin/upcomming-stockout-pdf')}}" style="float: right;margin-right:5px;"><button type="button" class="btn btn-success btn-sm"><i class="fas fa-download"></i> Download PDF</button></a>                
                @endif
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                        @php 
                            ...
                            $date2=date_create($purchase['ex_date']);
